        ...
        <div className="flex md:my-8 flex-col justify-center">
          ...
          <div className="flex flex-col items-center">
            <div className="grid grid-cols-1 md:grid-cols-3 w-full py-8 space-y-6 md:space-y-0 md:space-x-4">
              ...
              >
                <Link href="paketi">
                  <div className="flex items-center cursor-pointer flex-col border-2 border-green-500 shadow-xl ease-in-out transform transition duration-300 hover:scale-105">
                    <div className="bg-green-500 py-2 w-full text-center">
