        ...
        <div className="px-6 w-full py-4">
                  ...
                  <table className="min-w-full table-fixed border-2 border-primary rounded-lg shadow-lg">
                    <thead>
                      <tr>
                        ...
                        <th className="px-6 py-3 text-xl font-medium text-shadow leading-4 tracking-wider text-center text-green-500 uppercase border-b border-primary-metallic bg-hero3">
                          FREE
                        </th>
          ...
          <div className="py-12 space-y-6 md:hidden">
            <div className="border-2 border-green-500 rounded-lg">
              <h1 className="text-4xl uppercase italic px-4 py-2 bg-green-500 w-full text-gray-200 text-shadow">
                Free
              </h1>
