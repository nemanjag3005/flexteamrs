...
const Footer = () => {
  return (
    <div className="bg-hero2 bg-cover flex items-center justify-center flex-col">
        ...
        <div className="flex justify-center space-x-6">
          <div>
            ...
            <ul className="text-gray-200 text-sm space-y-2">
              <li className="cursor-pointer hover:text-primary">flexteamtips@gmail.com</li>
              <li className="cursor-pointer hover:text-primary">Instagram</li>
              <li className="cursor-pointer hover:text-primary">Youtube</li>
              <li className="cursor-pointer hover:text-primary">Paypal</li>
            </ul>
          </div>
          <div>
            <h1 className="text-primary mb-3">O Nama</h1>
            <ul className="text-gray-200 text-sm space-y-2">
              <li className="cursor-pointer hover:text-primary">Naša Priča</li>
              <li className="cursor-pointer hover:text-primary">Profit</li>
