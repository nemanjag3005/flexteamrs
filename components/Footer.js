...
const Footer = () => {
  return (
    <div className="bg-hero2 bg-cover flex items-center justify-center flex-col border-t-2 border-primary relative">
        <h1 className="absolute z-0 font-['Airbnb Cereal App'] font-bold opacity-30 text-transparent bg-clip-text bg-gradient-to-r from-primary-metallic to-transparent text-8xl tracking-widest top-[30%] left-36 ">
        FLEX
      </h1>
      <h1 className="absolute z-0 font-['Airbnb Cereal App'] font-bold opacity-30 text-transparent bg-clip-text bg-gradient-to-r from-transparent to-primary text-8xl tracking-widest top-[55%] left-2 ">
        TEAM
      </h1>
      <div className="flex flex-wrap justify-center md:justify-between w-full max-w-4xl items-center py-4 px-8">
        ...
        <div className="flex justify-center space-x-6">
          <div>
            <h1 className="text-primary text-md mb-3">Kontakt</h1>
          ...
          <div>
            <h1 className="text-primary mb-3">O Nama</h1>
            <ul className="text-gray-200 text-sm space-y-2">
              <li className="cursor-pointer hover:text-primary">
      ...
      <div className="py-4 px-8 text-gray-200 max-w-4xl text-xs text-center">
        ...
        <div>
          ...
          >
            <svg
              ...
              height="32"
              viewBox="0 0 24 24"
              className="fill-gray-200 hover:fill-primary cursor-pointer"
            >
              {" "}
